  ...
  return [
    {
      ...
      freq: gnd,
      prompt: `Call ${field} Ground for taxi. You are at the ramp with information ${r.atis(wx.atis)}, ${r.vfr} to ${dest.spoken}.`,
      example: `${field} Ground, ${full}, at the ramp with information ${r.atis(wx.atis)}, ${r.vfr} to ${dest.spoken}, request taxi.`,
